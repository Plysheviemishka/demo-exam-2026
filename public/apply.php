...
<section class="section-heading">
    <div>
        ...
        <p>Выберите курс, дату старта и удобный способ оплаты.</p>
    </div>
</section>

<form class="card form form--wide" method="post" novalidate>
    <input type="hidden" name="csrf_token" value="<?= e(csrf_token()) ?>">
    <div class="form__group">
        <label for="course_type_id">Вид курса</label>
        <select id="course_type_id" name="course_type_id" required>
